...
% 		enumarabic 			enumerated lists using arabic eg. 1.
%							else alpha roman a) (i) 
%
...
\documentclass[aspectratio=169, sectionpages,codehl,bibref]{beamer}
% > > > Bibliography File 
...
\title{sthlmNord Beamer Theme [version round(\(\pi, 2\))]}
